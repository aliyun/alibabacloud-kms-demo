...
/**
 * Alipay-easysdk使用KMS签名示例，本示例展示了证书模式调用
 */
public class KmsAlipayEasySDKCertDemo {
    ...
    private static AliyunKMSConfig getOptions() {
        ...
        config.appId = "202100****";
        // 请更换为您的应用公钥证书文件路径
        config.merchantCertPath = "appCertPublicKey_202100****.crt";
        // 请更换为您的支付宝公钥证书文件路径
        config.alipayCertPath = "alipayCertPublicKey_RSA2_202100****.crt";
        // 请更换为您的支付宝根证书文件路径
        config.alipayRootCertPath = "alipayRootCert_202100****.crt";
